...
module.exports.DEFAULT_SJCL_PARANOIA = 10;
module.exports.DEFAULT_SJCL_NUMWORDS = 2
module.exports.DEFAULT_SJCL_ITERATIONS = 1000;
module.exports.DEFAULT_SJCL_KEYSIZEBITS = 128;
module.exports.DEFAULT_SJCL_TAGLENGTH = 128;
 ...
 */
module.exports.sjclPbkdf2 = function sjclPbkdf2 (password, salt, iterations, keySizeBits)
{
 ...
 * returns: hex string
 */
module.exports.sjclRandomHex = function sjclRandomHex (numWords, paranoia)
{
 ...
 */
module.exports.sjclCCMencrypt = function sjclCCMencrypt (derivedKey, plainText, initVector, authData, tagLenBits)
{
 ...
 */
module.exports.sjclCCMdecrypt = function sjclCCMdecrypt (derivedKey, cipherText, initVector, authData, tagLenBits)
{
    // AES pseudorandom function based on derived key
    derivedKey = sjcl.codec.hex.toBits(derivedKey);
    var prf = new sjcl.cipher.aes(derivedKey);
